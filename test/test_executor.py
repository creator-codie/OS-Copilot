...
class TestExecutor:
    ...
    def test_generator_tool(self):
        ...
        """
        task_name, task_description, pre_tasks_info, relevant_code = (
            "move_files",
            "Move any text file located in the working_dir/document directory that contains the word 'agent' to a new folder named 'agent' ",
            "",
            "",
        )
